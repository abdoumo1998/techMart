...
export default function ResetPasswordPage() {
  ...
  const form = useForm<ResetPasswordForm>({ resolver: zodResolver(schema), defaultValues: { email: emailFromQuery } })
  ...
  return (
    <div className="w-11/12 sm:w-3/4 md:w-2/3 lg:w-3/4 xl:w-1/2 mx-auto my-8 p-4 sm:p-6 md:p-8 border border-gray-300 rounded-lg shadow-2xl bg-white">
      <h1 className="text-center font-bold text-2xl sm:text-3xl">Reset Password</h1>
      <Form {...form}>
